...
public class CotaInformation extends Activity {
    ...
    private void prepareListData() {
        ...
        seeAllCota.add("Cota Bus Route #1");
        seeAllCota.add("Cota Bus Route #2");
        seeAllCota.add("Cota Bus Route #3");
        seeAllCota.add("Cota Bus Route #4");
        seeAllCota.add("Cota Bus Route #5");
